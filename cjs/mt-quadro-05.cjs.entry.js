...
const Quadro05 = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '44733272aec6ca01a77ab16ec00c98a62d674d93', class: functions.generateClasses(produto, especialidade, ano, {
                'mt-quadro-05': true,
            }) }, index.h("div", { key: 'e5d90ac6908d28fadde296dce84491855830cdf5', class: "mt-quadro-05__container" }, index.h("h3", { key: '26380ef662b09b73aab128b5a3852f1350bfc567', class: "mt-quadro-05__title" }, index.h("slot", { key: '084fbffbf30256800a739dba9f91ae952e51af02', name: "title" })), index.h("p", { key: '2f4e7fcfec5013c2efbf4dbf7172c5f6e0aa8fa5', class: "mt-quadro-05__text" }, index.h("slot", { key: '2a71b1769ff87fb264c9ee9817e1b2fa267b8c71', name: "text" })))));
    }
};
