...
const Paragrafo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '18f19d9c8732dbcfb3e12afe320f8973a8b8be1e', class: functions.generateClasses(produto, especialidade, ano, {
                'mt-paragrafo': true,
            }) }, index.h("p", { key: '5356f7809cbe3640049f3fa3bd69c18eb03a6dcb', class: "mt-paragrafo__text" }, index.h("slot", { key: '265fb21e251adec86befdbb4bb4416bd2557ac84' }))));
    }
};
