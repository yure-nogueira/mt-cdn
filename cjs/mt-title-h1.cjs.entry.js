...
const TitleH1 = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4a91fca3e99216ec059b27c74bc6243ad1ee05f6', class: generateClasses(produto, especialidade, ano, 'title-h1', {
                'mt-title-h1': true,
            }) }, index.h("p", { key: 'eef1d7894f5be238b1e146beef80dee54254deeb', class: "mt-title-h1__pre-title" }, index.h("slot", { key: 'ad69250ac18cbcc315dacd7efda5cbfc4c2020ee', name: "pre-title" })), index.h("h1", { key: 'd3c7cd38e55ced6b71d5425c3470711632a56166', class: "mt-title-h1__title" }, index.h("slot", { key: '0bda99489551a0ad64f016bd5b72abd679ce247f', name: "title" })), index.h("h2", { key: '7863b4636904309557db53e03fc84b2b8c738600', class: "mt-title-h1__subtitle" }, index.h("slot", { key: '3822d78eafcd30c5ab98a7c2e2149b043662a858', name: "subtitle" }))));
    }
};
